...
?>
    ...
    <head>
        ...
        <title>テンプレート - イージースター メール配信システム</title>
    ...
    <body>
        ...
        <div id="contents">
            <div id="main-contents" class="template">
                <h1>テンプレート</h1>
                <a href="template-add.php" class="button">追加</a>
                <a href="template-edit.php" class="button">変更</a>
                <a href="template-delete.php" class="button">削除</a>
            </div>
        </div>
    </body>
