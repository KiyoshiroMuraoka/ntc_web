...
$subject = "【日本テクノクラーツ株式会社 ネットショップ商品データ移行サービスお問い合わせ ご確認】";
...
$thanksPage = "https://www.technocrats.jp/confirm/csv.html";
...
$eles = array('御社名','郵便番号','住所1','電話番号','担当者様の氏名','フリガナ','Email');
...
$re_subject = "【日本テクノクラーツ株式会社 ネットショップ商品データ移行サービスお問い合わせのご確認】";
...
この度は、「ネットショップ商品データ移行サービス」へのお問い合わせ頂きましてありがとうございます。
以下の内容で確かに承りました。
...
<title>ネットショップ商品データ移行サービス｜お問い合わせ｜日本テクノクラーツ株式会社</title>
...
<div class="contentsWrap">
	<div class="contents">
<h2 class="heading01">ネットショップ商品データ移行サービス　お問い合わせフォーム</h2>
