...
$subject = "【日本テクノクラーツ株式会社 プライバシーマーク取得サービスお申し込み ご確認】";
...
$eles = array('御社名','郵便番号','住所','電話番号','社員数','拠点数','業種','担当者様の氏名','フリガナ','Email');
...
$re_subject = "【日本テクノクラーツ株式会社 プライバシーマーク取得サービスお申し込みのご確認】";
...
この度は、「プライバシーマーク取得サービス」にお申し込みいただきましてありがとうございます。
以下の内容で確かに承りました。
...
<title>プライバシーマーク取得支援サービス｜お申し込み｜日本テクノクラーツ株式会社</title>
...
<div class="contentsWrap">
	<div class="contents">
<h2 class="heading01">プライバシーマーク取得支援サービス　お申し込みフォーム</h2>
