                ...
                <form action="confirm.php" method="post" role="form" id="form">
                    ...
                    <span class="tcell-r">
                      <ul class="bg_radiobox">
                        <span id="service-1"><li><input type="radio" name="service" value="ChangeOverWowma" class="form-control"<?php if($service=="ChangeOverWowma") echo ' checked="checked"'?> /><label for="service-1" class="check">&nbsp;商品データ移行サービス (Wowma!専用プラン)</label></li></span><br />
                      </ul>
                    </span>
                    ...
                    <span class="tcell-r"><textarea name="body" id="body" cols="50" rows="8" class="form-control textbox textmain" placeholder="例：Wowma!の紹介によりご依頼させて頂きました。よろしくお願いします。"><?php echo $body; ?></textarea></span>
