...
<head>
    <title>確認 | イージースター お問い合わせフォーム - Wowma専用プラン</title>
        ...
        <fieldset id="contactForm">
            ...
            <div id="confirmArea">
                ...
                <span class="tr">
                  ...
                  <span class="tcell-r"><?php if($service=="ChangeOverWowma"){ echo "商品移行サービス<br>(Wowma専用プラン)";} ?></span>
                </span>
                <span class="tr">
	<?php
		if($service=="ChangeOverWowma"){
            ...
            echo "</span>"; } ?>
                ...
                <span class="tr">
                  <span class="tcell-l">Wowma!紹介テンプレート：</span>
                  <span class="tcell-r"><?php echo $introbody; ?></span>
                </span>
                <span class="tr">
