        ...
        <div id="formArea">
            <fieldset id="contactForm">
                ...
                <form action="confirm.php" method="post" role="form" id="form">
                    ...
                    <div class="tcell">
                        <span>画像認証<!--画像認証（Securimage）--></span>
                        <table style="border:0px; width:580px;" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="margin:0px; padding:0px;">　<a href="#" onclick="document.getElementById('captcha').src = './securimage/securimage_show.php?' + Math.random(); return false"><img src="./securimage/images/refresh.png" class="securimage alt="別の画像を表示" height="25" class="vertical-align:bottom;" id="refresh" /></a></td>
                            </tr>
                        </table>
                        <table style="border:0px; width:580px;" cellpadding="0" cellspacing="0">
                            <tr>
