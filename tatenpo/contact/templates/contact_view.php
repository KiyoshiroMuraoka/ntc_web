        ...
        <div id="formArea">
            <fieldset id="contactForm">
                ...
                <form action="confirm.php" method="post" role="form" id="form">
                    ...
                    <span class="tcell-r"><input type="text" name="emailreq" id="emailreq" value="" size="50" class="form-control textbox validate[required,equals[emailadd]]" oncopy="return false" onpaste="return false" oncontextmenu="return false" /></span>
