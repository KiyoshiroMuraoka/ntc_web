            ...
            <fieldset id="contactForm">
                ...
                <form action="confirm.php" method="post" role="form" id="form">
                    ...
                    <div class="tcell">
                        ...
                        <span>
                          <ul class="bg_radiobox">
                            <span id="service-1"><li><input type="radio" name="service" value="ChangeOverYahoo" class="form-control"<?php if($service=="ChangeOverYahoo"){echo ' checked="checked"';}?> /><label for="service-1" class="check">&nbsp;&nbsp;商品データ移行サービス</label></li></span><br /><br />
                          </ul>
                        </span>
                    </div>
                    ...
                    <div class="tcell">
                        ...
                        <br />
                        <span><textarea name="body" id="body" cols="50" rows="8" class="form-control textbox textmain" placeholder="例：Yahoo!コマースパートナーマーケットプレイスの紹介によりご依頼させて頂きました。よろしくお願いします。"><?php echo $body; ?></textarea></span>
                    </div>
