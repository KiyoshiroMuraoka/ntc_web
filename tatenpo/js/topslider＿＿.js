	$(function(){
		var slideCurrent = 0;
		var slideWidth = $(".slide img").innerWidth();
		var slideNum = $('.slide').length;
		var slideboxWidth = slideWidth * slideNum;
		...
		var btnWidth = $(".slidebtn > span").innerWidth() * slideNum;//●全体の幅を取得してセンターに
			...
			var loop = setInterval(function(){
				if(btnidno == slideCurrent){//ボタンと画像番号が一緒ならループを止める
					...
					if(flag==2){
						...
						$(".sliderbox > div:nth-child(2)").animate(//先頭から二つ目を削除
